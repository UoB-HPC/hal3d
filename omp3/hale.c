...
// Generate a subcell mesh from the cell mesh
void init_subcell_mesh(const int nnodes, int* subcells_to_faces,
                       int* faces_to_nodes, int* subcells_to_nodes,
                       int* subcells_to_subcells, int* nodes_to_subcells,
                       int* subcell_neighbours,
                       int* subcells_to_subcells_offsets, double* nodes_x,
                       double* nodes_y, double* nodes_z,
                       double* subcell_nodes_x, double* subcell_nodes_y,
