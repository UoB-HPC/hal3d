...
void gather(const int ncells, const int nnodes, const int *cells_offsets,
            const int *cells_to_nodes, const int *cells_to_cells,
            const double *cell_centroids_x, const double *cell_centroids_y,
            const double *nodes_x0, const double *nodes_y0,
            const double *energy, const double *density,
