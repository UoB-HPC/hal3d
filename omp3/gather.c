...
void gather_cell_momentum(const int nnodes, const double* nodal_volumes,
                          const double* nodal_mass, int* nodes_to_cells,
                          const double* nodes_x, const double* nodes_y,
                          const double* nodes_z, double* velocity_x,
                          double* velocity_y, double* velocity_z,
                          double* cell_centroids_x, double* cell_centroids_y,
                          double* cell_centroids_z, int* nodes_to_cells_offsets,
...
void gather_cell_quantities(UnstructuredMesh* umesh, HaleData* hale_data,
                            vec_t* initial_momentum) {
