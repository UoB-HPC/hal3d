...
#pragma omp parallel
  ...
  for (tt = 0; tt < mesh.niters; ++tt) {
    ...
    solve_unstructured_hydro_2d(
        ...
        umesh.cells_to_cells, umesh.nodes_offsets, umesh.nodes_x0,
        umesh.nodes_y0, umesh.nodes_x1, umesh.nodes_y1, umesh.boundary_index,
        ...
        hale_data.velocity_y1, hale_data.sub_cell_force_x,
        hale_data.sub_cell_force_y, hale_data.node_force_x,
        hale_data.node_force_y, hale_data.node_force_x2,
